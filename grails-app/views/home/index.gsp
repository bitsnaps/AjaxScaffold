...
<body>
	...
	<section id="intro" class="first">
		<h1>Welcome to Kickstart with Bootstrap 3.3.2 for Grails 2.4</h1>
		<p>
	...
	<section id="info">
		<div class="row">
	    	<div class="col-md-4">
		    	<div class="center">
					<img class="frontpageImage" src="${assetPath(src: 'frontpage/bs-docs-twitter-github.png')}" />
	    	...
	    	<div class="col-md-4">
		    	<div class="center">
					<img class="frontpageImage" src="${assetPath(src: 'frontpage/browser_logos.png')}" />
	    	...
	    	<div class="col-md-4">
		    	<div class="center">
					<img class="frontpageImage" src="${assetPath(src: 'frontpage/html5css3js8.png')}"/>
				...
				Kickstart is built using Groovy 2.x and Java 7 integrated into the Grails 2.4.x framework. 
				</p>
			</div>
	    </div>
	</section>
	...
	<section id="info2">
		<div class="row">
	    	<div class="col-md-4">
		    	<div class="center">
					<img class="" src="${assetPath(src: 'frontpage/Datepicker.png')}" />
					<h3>Datepicker</h3>
				</div>
	    	...
	    	<div class="col-md-4">
		    	<div class="center">
					<img class="" src="${assetPath(src: 'frontpage/flags_preview_large.png')}" />
	    	...
	    	<div class="col-md-4">
		    	<div class="center">
					<img class="" height="100" src="${assetPath(src: 'frontpage/empty.png')}" />
