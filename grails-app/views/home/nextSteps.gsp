...
&lt;r:require modules="bootstrap_less_utils"/&gt;</pre>
		...
		<ol>
			<li>Install <a href="http://grails.org/plugin/spring-security-core">spring-security-core</a> in BuildConfig.groovy, e.g.: <pre>compile ":spring-security-core:2.0.0"</pre> </li>
			<li>Clean and compile your app to load the plugin</li>
			<li>Execute the <a href="http://grails-plugins.github.io/grails-spring-security-core/2.0.x/ref/Scripts/s2-quickstart.html">s2-quickstart script</a> to generate the required domain classes <pre>grails s2-quickstart com.yourapp User Role</pre></li>
			<ul>
			...
			<li>Set security configuration in your Config.groovy (see <a href="http://grails-plugins.github.io/grails-spring-security-core/2.0.x/guide/single.html#requestMappings">here</a>), you can restrict access to a URL using the optimistic approach e.g.: 
<pre>grails.plugin.springsecurity.rejectIfNoRule = false
grails.plugin.springsecurity.fii.rejectPublicInvocations = false</pre>

</li>
<li>By default only POST requests are allowed to trigger a logout. To allow GET access, add this:
<pre>grails.plugin.springsecurity.logout.postOnly = false</pre></li>
<li>Elasticsearch is available as plugin for Grails 2.x (see <a href="https://grails.org/plugin/elasticsearch?skipRedirect=true">ElasticSearch</a>)
</li>
