...
modules = {
	...
	'bootgrid' {
		dependsOn 'bootstrap'
		resource url: [dir: 'bootgrid/js', file: 'jquery.bootgrid.min.js']
		resource url: [dir: 'bootgrid/css', file: 'jquery.bootgrid.min.css']
	}

	'bootcrud' {
		dependsOn 'bootstrap,bootgrid'
		resource url: [dir: 'js', file: 'bootcrud.js']
	}
